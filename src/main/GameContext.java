...
/**
 * The game context holds the current state of the game. It undergoes a lifecycle
 * enforced by the TurnController whereby the current context is cloned, mutated,
 * validated, and if valid becomes the new current state.
 */
class GameContext
{
    ...
    /**
     * Clone constructor. Creates a new GameContext that is a duplicate of
     * the argument. 
     */
    ...
    //  - Player opposingPlayer(); (sidenote: we assume two users, which is why this isn't a list)
    //  - Player thisPlayer();
