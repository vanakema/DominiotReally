...
/**
 * This class tracks a collection of cards representing the unowned game objects.
 * Cards are `bought' from this deck by players and added to their deck, at
 * which time they are removed from the supply deck.
 */
public class SupplyDeck
{
    ...
    /**
     * Create a new SupplyDeck with the specified action cards. Victory and Treasure
     * cards will be automatically populated according to game rules.
     * 
